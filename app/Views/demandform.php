...
<html lang="en">
    ...
    <div class="page-content p-5" id="content">
        <form id="demand_form" action="<?php echo base_url(); ?>/DemandForm/AddDemand" name = "demand_form" method="post">
            <?= csrf_field() ?>
            <div class="row mb-3">
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6 col">
                    <div class="input-group">
                        <span class="input-group-text">Demand ID</span>
                        <input type="text" readonly class="form-control" id="demandID" value="1">
                    </div>
                </div>
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6 col">
                    <div class="input-group">
            ...
            <div class="row mb-3">
                ...
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6 col">
                    <div class="input-group">
                        ...
                        <input type="text" aria-label="Job Title" class="form-control" id="JTitle" placeholder="Job Title">
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6 col">
                    <div class="input-group">
                        <span class="input-group-text">Demand Name</span>
                        <input type="text" aria-label="Demand Name" class="form-control" id="demandName" placeholder="Demand Name">
                    </div>
                </div>
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6 col">
                    <div class="input-group">
            ...
            <div class="row mb-3">
                ...
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6 col">
                    <div class="input-group">
                        ...
                        <input type="text" aria-label="Notice Period" class="form-control" placeholder="30" id="NP">
                    </div>
                </div>
            </div>
            <div class="mb-3 row">
